...
- signatures + parameters + return types
    * XS keyword plugin: <https://metacpan.org/pod/Function::Parameters>
        + re-exported by:
            + <https://metacpan.org/pod/Syntax::Feature::Function>
            + <https://metacpan.org/pod/routines>
...
- OO
    ...
    * <https://metacpan.org/pod/Sub::Private>
- Operators
    * Smart-match
        ...
        + <https://metacpan.org/pod/Acme::CPANModules::SmartMatch>
    * `isa`
    ...
    * Quote-likes
        ...
        + <https://metacpan.org/pod/Syntax::Feature::Qn>
        + <http://neilb.org/2016/08/08/quoted-words-arrayref.html>
    * Non-det
...
- Types
    ...
    * checking / constraints
        ...
        + <https://metacpan.org/pod/Magic::Check>
            + <https://metacpan.org/pod/Magic::Coerce>
